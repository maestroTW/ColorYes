...
function readMore() {
    ...
    if(dots.style.display === "none") {
        dots.style.display = "none";
        btn.innerHTML = "This site will help you choose the right color palette for your project. Press 'Space' to change color. Click on the color to copy its id. Was developed by maestroTW."
        more.style.display = "inline";
    }
    else {
        dots.style.display = "inline";
